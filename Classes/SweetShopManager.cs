...
/*******Item Utilities************************************************************************************/
        ...
        public List<Item> selectAllItems()
        {
            ...
            while (read.Read())
            {
                Item i = new Item(Convert.ToInt32(read["SKU"]),
        ...
        public List<Item> singleItemLookUp(int SKU)
        {
            //New Command
            SqlConnection con = new SqlConnection(connectionString);
            SqlCommand cmd = new SqlCommand();
        ...
        public Item getItem(int SKU)
        {
            ...
            while (read.Read())
            {
                    item = new Item(Convert.ToInt32(read["SKU"]),
                    read["brand"].ToString(),
                    read["model"].ToString(),
                    read["clubType"].ToString(),
                    read["shaft"].ToString(),
        ...
        public void addItem(Item i)
        {
            ...
            cmd.Parameters.AddWithValue("shipmentDate",i.shipmentDate );
            cmd.Parameters.AddWithValue("brand", i.brand);
            cmd.Parameters.AddWithValue("model", i.model);
            cmd.Parameters.AddWithValue("clubType", i.clubType);
            cmd.Parameters.AddWithValue("shaft", i.shaft);
            cmd.Parameters.AddWithValue("numberOfClubs", i.numberOfClubs);
            cmd.Parameters.AddWithValue("tradeInPrice", i.tradeInPrice);
            cmd.Parameters.AddWithValue("premium", i.premium);
            cmd.Parameters.AddWithValue("wePay", i.wePay);
            cmd.Parameters.AddWithValue("quantity", i.quantity);
            cmd.Parameters.AddWithValue("extendedPrice",i.extendedPrice);
            cmd.Parameters.AddWithValue("retailPrice",i.retailPrice);
            cmd.Parameters.AddWithValue("comments",i.comments);
            cmd.Parameters.AddWithValue("clubSpec",i.clubSpec);
            cmd.Parameters.AddWithValue("shaftSpec",i.shaftSpec);
            cmd.Parameters.AddWithValue("shaftFlex",i.shaftFlex);
            cmd.Parameters.AddWithValue("dexterity",i.dexterity);
            cmd.Parameters.AddWithValue("destination",i.destination);
            cmd.Parameters.AddWithValue("received",i.received);
            cmd.Parameters.AddWithValue("paid",i.paid);
        ...
        public void updateItemInvoice(Item i)
        {
            SqlConnection con = new SqlConnection(connectionString);
            SqlCommand cmd = new SqlCommand();
            ...
            cmd.Parameters.AddWithValue("@sku", i.sku);
            cmd.Parameters.AddWithValue("@quantityInOrder", i.quantityInOrder);
            cmd.Parameters.AddWithValue("@brand", i.brand);
            cmd.Parameters.AddWithValue("@model", i.model);
            cmd.Parameters.AddWithValue("@clubType", i.clubType);
            cmd.Parameters.AddWithValue("@shaft", i.shaft);
