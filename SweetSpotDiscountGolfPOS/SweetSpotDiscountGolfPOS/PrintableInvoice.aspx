   ...
   <%-- <script>
    ...
    <div id="printable" runat="server">
            ...
            <asp:GridView ID="grdItemsSoldList" runat="server" CellPadding="4" Width="70%" AutoGenerateColumns="False">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Retail Price">
                        <ItemTemplate>
                            <asp:Label ID="retail" Text='<%#Eval("price")%>' runat="server"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Discounts Applied">
                        <ItemTemplate>
                            <asp:Label ID="discount" Text='<%#Eval("discount")%>' runat="server"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
        ...
        <div id="paymentDetails" class="yesPrint">
            ...
            <asp:Table ID="tblSummary" runat="server" Width="100%">
                <asp:TableRow>
            ...
            <br />
            <div class="noPrint">
                <asp:Button ID="btnPrint" runat="server" Text="Print" Width="100px" OnClientClick="printReport(printable)" />
                <br />
